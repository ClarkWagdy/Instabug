          ...
          <div id="target" className="half">
            <div className="login-side">
                  ...
                  <form onSubmit={this.handelsubmit}>
                    ...
                    <div>
                      ...
                      <p className="lable-lab signup-line">
                        ...
                        <Link to="/" className=" signup">Login via SSO</Link>{" "}
                      </p>
                    </div>
                  </form>
                </div>
              ...
              <div className="login-data">
                ...
                <p className="lable-lab logos">
                  <span>
                    <svg viewBox="0 0 39 28" style={{ width: "30" }}>
                  ...
                  <span>
                    <svg viewBox="0 0 853.3 150.1" style={{ width: "70" }}>
                  ...
                  <span>
                    <svg viewBox="0 0 66 17" style={{ width: "70" }}>
                  ...
                  <span>
                    <svg viewBox="0 0 600 100" style={{ width: "120" }}>
                      <path
